...
struct Colores {
    let colores = [UIColor(red: 10/255, green: 200/255, blue: 188/255, alpha: 1),
        UIColor(red: 144/255, green: 233/255, blue: 7/255, alpha: 1),
        UIColor(red: 1/255, green: 23/255, blue: 110/255, alpha: 1),
        UIColor(red: 205/255, green: 5/255, blue: 18/255, alpha: 1),
        UIColor(red: 156/255, green: 98/255, blue: 167/255, alpha: 1),
        UIColor(red: 90/255, green: 156/255, blue: 233/255, alpha: 1),
        UIColor(red: 123/255, green: 78/255, blue: 8/255, alpha: 1),
        UIColor(red: 186/255, green: 123/255, blue: 67/255, alpha: 1)
    ]
...
struct Datos {
    ...
    func regresaFrase () -> String {
        let frasePosicion = Int(arc4random()) % frases.count
        return frases[frasePosicion]
    }
}